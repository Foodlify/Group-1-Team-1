...
-- CreateIndex
CREATE UNIQUE INDEX "OrderSummary_customer_id_key" ON "OrderSummary"("customer_id");
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_payment_type_id_fkey" FOREIGN KEY ("payment_type_id") REFERENCES "PaymentType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PaymentConfiguration" ADD CONSTRAINT "PaymentConfiguration_pay_Type_id_fkey" FOREIGN KEY ("pay_Type_id") REFERENCES "PaymentType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Transaction" ADD CONSTRAINT "Transaction_pay_type_id_fkey" FOREIGN KEY ("pay_type_id") REFERENCES "PaymentType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
